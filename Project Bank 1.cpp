...
// ===========================================================
// A simple console-based CRUD application for managing bank
// clients, plus basic deposit/withdraw transactions.
//
// Data is persisted in a flat text file (Clients.txt), one
// record per line, with fields separated by the "#//#" token.
// Record format: AccountNumber#//#PinCode#//#Name#//#Phone#//#AccountBalance
// ===========================================================
...
{
    return ReadValidatedShort("Choose what do you want to do? [1 to 7]? ");
}
